    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
      ...
      <div className="order-1 lg:order-2 space-y-6">
        <h2 className="text-2xl md:text-3xl font-bold text-black mb-4">
          FAITH INIABASSEY AMAKU
        </h2>
        
        <div className="space-y-4 text-black">
          <p className="text-sm md:text-base leading-relaxed text-justify">
            Faith is a distinguished legal professional with a comprehensive educational 
            background. She holds a Bachelor of Laws (LL.B.) from Afe Babalola University 
            and a Barrister-at-Law (BL) degree from the Nigerian Law School.
          </p>
          
          <p className="text-sm md:text-base leading-relaxed text-justify">
            Her commitment to the field of conflict resolution is evident through her 
            ...
            Chartered Institute of Arbitrators (CIArb) in the UK.
          </p>
          
          <p className="text-sm md:text-base leading-relaxed text-justify">
            Before joining Evian & Co, she gained invaluable experience through 
            internships at several prestigious law firms. These roles allowed her to develop 
            and refine key skills in legal research, advocacy, and problem-solving, while 
            also providing her with hands-on exposure to the complexities of legal 
            practice.
          </p>
