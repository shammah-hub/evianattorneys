  ...
  return (
    ...
    <section className="max-w-7xl mx-auto p-12 bg-white">
      <div className="mb-8">
        ...
        <div className="relative h-64 bg-[url('/ene.svg')] bg-cover bg-no-repeat bg-center flex items-center justify-center">
        ...
        <div className="prose prose-gray max-w-none">
          <p className="text-gray-700 leading-relaxed ">
           ...
           ventures, as well as renewable energy projects, and much more, all tailored to the unique dynamics of the Nigerian 
           energy market. Our attorneys are well-versed in the regulatory frameworks governing the energy industry and are 
           equipped to handle complex transactions, compliance issues, and dispute resolution in this critical sector.
          </p>
        </div>
      </div>
    </section>
