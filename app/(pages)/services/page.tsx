...
// Define interface for practice items
interface Practice {
  title: string;
}

export default function Page() {  // Changed from lowercase 'page' to uppercase 'Page'
  ...
  const practicesByCategory: Record<string, string[]> = {
    'Intellectual Property': [
  ...
  const getFilteredPractices = (): Practice[] => {
    if (selectedFilter === 'All Practices') {
      return allPractices;
    } else {
      return practicesByCategory[selectedFilter].map(
        (title: string) => ({ title })
      );
    }
  };
            ...
            <div className="md:w-2/3 md:pl-8 mt-8 md:mt-0">
              ...
              <div className="flex flex-col md:flex-row">
                ...
                <div className="md:w-1/2 md:pr-4">
                  {leftColumnPractices.map((practice: Practice, index: number) => (
                    <a 
                      key={index} 
                      href="#" 
                ...
                <div className="md:w-1/2 md:pl-4 mt-6 md:mt-0">
                  {rightColumnPractices.map((practice: Practice, index: number) => (
                    <a 
                      key={index} 
                      href="#" 
                      className="block text-orange-500 hover:text-orange-700 mb-4"
